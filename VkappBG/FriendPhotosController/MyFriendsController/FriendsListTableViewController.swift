...
class FriendsListTableViewController: UITableViewController, UISearchBarDelegate, UINavigationControllerDelegate {
    ...
    let myFriends = [
        Friends(name: "Bogdan", mainPic: "1", pics: [FriendImages(name: "1"), FriendImages(name: "1a"), FriendImages(name: "1b")], about: nil),
        Friends(name: "Mark", mainPic: "2", pics: [FriendImages(name: "2"), FriendImages(name: "2a"), FriendImages(name: "2b")], about: nil),
        Friends(name: "Daria", mainPic: "3", pics: [FriendImages(name: "3"), FriendImages(name: "3a"), FriendImages(name: "3b")], about: nil),
